...
class IVDripsTherapyPackagesClinic extends StatefulWidget {
  IVDripsTherapyPackagesClinic({
    super.key,
  });

  @override
  State<IVDripsTherapyPackagesClinic> createState() =>
      _IVDripsTherapyPackagesClinicState();
}

class _IVDripsTherapyPackagesClinicState
    extends State<IVDripsTherapyPackagesClinic> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<Object>(
          stream: FirebaseFirestore.instance
              .collection("services")
              .where("serviceCategory", isEqualTo: "IV Drips Therapy Packages")
