...
class BodyContouringPageClinic extends StatefulWidget {
  BodyContouringPageClinic({
    super.key,
  });

  @override
  State<BodyContouringPageClinic> createState() =>
      _BodyContouringPageClinicState();
}

class _BodyContouringPageClinicState extends State<BodyContouringPageClinic> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<Object>(
          stream: FirebaseFirestore.instance
              .collection("services")
              .where("serviceCategory", isEqualTo: "Body Contouring Packages")
